...
class AirCargoProblem(Problem):
    ...
    def get_actions(self):
        ...
        # The actions for the planning problem must be concrete because the problems in
    ...
    def result(self, state: str, action: Action):
        ...
        for effect_add in action.effect_add:
            if effect_add not in new_state.pos:
                new_state.pos.append(effect_add)
        for effect_rem in action.effect_rem:
            if effect_rem not in new_state.neg:
                new_state.neg.append(effect_rem)
